...
// PROSES PEMESANAN CUSTOMER (SEKARANG LANGSUNG BISA CETAK PDF)
function prosesBookingCustomer(event) {
  ...
  // Tanya ke customer apakah mau cetak PDF sekarang
...
// ZONA & KALKULASI HARGA
const dataZona = {
  "Jakarta": 1, "Bogor": 1, "Bandung": 2, "Sukabumi": 2, "Cianjur": 2, "Cirebon": 3, "Tegal": 3, "Pekalongan": 3, "Purwokerto": 3,
  "Semarang": 4, "Yogyakarta": 4, "Solo": 4, "Wonogiri": 4, "Temanggung": 4, "Kudus": 4, "Rembang": 4,
  "Tuban": 5, "Surabaya": 5, "Malang": 5, "Batu": 5, "Kediri": 5, "Blitar": 5,
  "Banyuwangi": 6, "Gilimanuk": 6, "Denpasar": 6
};

const tarifHarga = {
  1: { "Elf (12-20 Kursi)": 1300000, "Medium Bus (25-39 Kursi)": 2000000, "Big Bus (45-59 Kursi)": 3200000, "Truk Engkel": 900000, "Truk Fuso": 1800000, "Truk Trailer": 3500000 },
  2: { "Elf (12-20 Kursi)": 1600000, "Medium Bus (25-39 Kursi)": 2500000, "Big Bus (45-59 Kursi)": 3800000, "Truk Engkel": 1800000, "Truk Fuso": 3500000, "Truk Trailer": 6000000 },
  3: { "Elf (12-20 Kursi)": 2000000, "Medium Bus (25-39 Kursi)": 3200000, "Big Bus (45-59 Kursi)": 4800000, "Truk Engkel": 3500000, "Truk Fuso": 6500000, "Truk Trailer": 11000000 },
  4: { "Elf (12-20 Kursi)": 2300000, "Medium Bus (25-39 Kursi)": 3700000, "Big Bus (45-59 Kursi)": 5500000, "Truk Engkel": 3500000, "Truk Fuso": 6500000, "Truk Trailer": 11000000 },
  5: { "Elf (12-20 Kursi)": 2700000, "Medium Bus (25-39 Kursi)": 4300000, "Big Bus (45-59 Kursi)": 6500000, "Truk Engkel": 4800000, "Truk Fuso": 8500000, "Truk Trailer": 15000000 },
  6: { "Elf (12-20 Kursi)": 3200000, "Medium Bus (25-39 Kursi)": 5000000, "Big Bus (45-59 Kursi)": 7500000, "Truk Engkel": 6500000, "Truk Fuso": 12000000, "Truk Trailer": 20000000 }
};
...
function hitungHarga() {
  ...
  if (selectedUnit && selectedTujuan) {
    const zona = dataZona[selectedTujuan];
    if (zona && tarifHarga[zona] && tarifHarga[zona][selectedUnit]) {
      const hargaPerHari = tarifHarga[zona][selectedUnit];
      const totalHarga = hargaPerHari * durasiHari;

      displayRateInfo.innerText = "Tarif Per Hari: Rp " + hargaPerHari.toLocaleString("id-ID") + " (" + durasiHari + " Hari)";
...
// FUNGSI CETAK PDF (VERSI DIRECT DOWNLOAD - ANTI MACET PRATINJAU HP)
function cetakPDF(namaUnit, dataBooking) {
  try {
    ...
    doc.setFontSize(18);
    doc.setTextColor(30, 58, 138); // Warna Biru
    ...
    doc.setLineDashPattern([], 0); // Reset garis lurus
    ...
    // 5. TOTAL PEMBAYARAN BOX
    doc.setFillColor(241, 245, 249);
    doc.rect(15, finalY, 180, 16, 'F');
    doc.setFillColor(30, 58, 138);
    doc.rect(15, finalY, 2, 16, 'F'); // Border kiri biru
    ...
    // 8. SIMPAN LANGSUNG SEBAGAI FILE PDF
